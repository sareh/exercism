...
describe('count()', function() {
  ...
  it('handles properties that exist on Object’s prototype - twice', function() {
    var expectedCounts = { reserved: 1, words : 1, like :1,  prototype: 1, and : 1, toString: 5,  'ok?': 1};
    expect(words.count('reserved words like prototype and toString ok? toString toString toString toString')).toEqual(expectedCounts);
  });
});
